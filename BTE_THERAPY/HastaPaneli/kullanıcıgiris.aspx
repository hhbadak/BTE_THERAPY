<%@ Page Title="" Language="C#" MasterPageFile="~/HastaPaneli/hasta.Master" AutoEventWireup="true" CodeBehind="kullanıcıgiris.aspx.cs" Inherits="BTE_THERAPY.HastaPaneli.WebForm2" %>
...
<body>
                                ...
                                <div class="m-sm-4">
                                    ...
                                    <form id="form1" runat="server">
                                        ...
                                        <div class="text-center mt-3">
                                            <asp:LinkButton ID="kullanici_giris" runat="server" Text="Giriş Yap" CssClass="btn btn-lg btn-primary" OnClick="kullanici_giris_Click"></asp:LinkButton>
                                        </div>
                                    </form>
                                </div>
                            </div>
    ...
    <script src="../HastaPaneli/js/app.js"></script>
